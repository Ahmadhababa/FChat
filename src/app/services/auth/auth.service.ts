...
import { Auth, createUserWithEmailAndPassword, getAuth, onAuthStateChanged, sendPasswordResetEmail, signInWithEmailAndPassword, updateCurrentUser } from '@angular/fire/auth';
    ...
    async register(formValue){
      try{
        ...
        const data = {
          ...
          photo: 'https://i.pravatar.cc/' + this.randomIntFromInterval(100, 500)
        };
